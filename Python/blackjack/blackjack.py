...
values={'A':11,'6':6,'2':2,'3':3,'4':4,'5':5,'7':7,'8':8,'9':9,'J':10,'Q':10,'K':10}
...
while True:
        ...
        try:
            ...
            if bet<=0 or bet>total:
                print("Your bet must be a positive int no larger than your total of: " + str(total))
                if total==0:
                    ch=input("You are out of money, do you wish to beg for it? (y or n)\nYour choice: ")
                    if ch.startswith('y'):
