...
if ch==1:
    ...
    if ch2==1:
        if income<=11000:
            ...
            tax=11000*0.1+33725*0.12+50650*0.22+86725*0.24+(income-182100)*0.32
        elif income<=578125:
            tax=11000*0.1+33725*0.12+50650*0.22+86725*0.24+49150*0.32+(income-231250)*0.35
        else:
            tax=11000*0.1+33725*0.12+50650*0.22+86725*0.24+49150*0.32+346875*0.35+(income-578125)*0.37
    elif ch2==2:
        if income<=22000:
            tax = income*0.1
        elif income<=89450:
            ...
            tax = 2200 + 67450*0.12+101300*0.22+173449*0.24+(income-364200)*0.32
        elif income<=693751:
            tax = 2200 + 67450*0.12+101300*0.22+173449*0.24+98300*0.32+(income-462500)*0.35
        else:
            tax = 2200 + 67450*0.12+101300*0.22+173449*0.24+98300*0.32+231249*0.35+(income-693751)*0.37
    elif ch2==3:
        if income<=11000:
            tax = income*0.1
        elif income<=44725:
            ...
            tax = 1100+33725*0.12+50649*0.22+86725*0.24+(income-182100)*0.32
        elif income<=346875:
            tax = 1100+33725*0.12+50649*0.22+86725*0.24+49149*0.32+(income-231250)*0.35
        else:
            tax = 1100+33725*0.12+50649*0.22+86725*0.24+49149*0.32+115624+(income-346875)*0.37
    else:
        if income<=15700:
            tax = income*0.1
        if income<=59850:
        ...
        if income<=231250:
            tax = 1570+44150*0.12+35499*0.22+86749*0.24+(income-182100)*0.32
        if income<=578100:
            tax = 1570+44150*0.12+35499*0.22+86749*0.24+49149*0.32+(income-231500)*0.35
        else:
            tax = 1570+44150*0.12+35499*0.22+86749*0.24+49149*0.32+346849*0.35+(income-578100)*0.37
    ...
    while not isinstance(t,int):
        try:
            ...
            print("Incorrect value entered, your income must be a positive integer, either 1 or 2")
            t = input("Are you:\n1) Self-employed\n2) An employee\nYour choice: ")
    if t==1:
        if income<=10000:
            tax=0
